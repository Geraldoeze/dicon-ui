...
// node_modules/@strapi/content-manager/dist/admin/chunks/index-njcS3gUl.mjs
...
var ProtectedHistoryPage = React.lazy(() => import("./History-BIzCrHlU-M3SPBZ4O.js").then((mod) => ({
...
var ProtectedPreviewPage = React.lazy(() => import("./Preview-DGQMt8XZ-3WK3QPDN.js").then((mod) => ({
...
var ProtectedEditViewPage = (0, import_react.lazy)(() => import("./EditViewPage-B9oaTSxh-VMCXJXQM.js").then((mod) => ({
  default: mod.ProtectedEditViewPage
})));
var ProtectedListViewPage = (0, import_react.lazy)(() => import("./ListViewPage-lpuA2rS8-HUO656HX.js").then((mod) => ({
  default: mod.ProtectedListViewPage
})));
var ProtectedListConfiguration = (0, import_react.lazy)(() => import("./ListConfigurationPage-JWHsiJKb-GRFSRELP.js").then((mod) => ({
  default: mod.ProtectedListConfiguration
})));
var ProtectedEditConfigurationPage = (0, import_react.lazy)(() => import("./EditConfigurationPage-DSSrKbwM-BQFHCN6B.js").then((mod) => ({
  default: mod.ProtectedEditConfigurationPage
})));
var ProtectedComponentConfigurationPage = (0, import_react.lazy)(() => import("./ComponentConfigurationPage-D6mjS3eX-JL6R2E2F.js").then((mod) => ({
  default: mod.ProtectedComponentConfigurationPage
})));
var NoPermissions = (0, import_react.lazy)(() => import("./NoPermissionsPage-CihsLbNC-3OAIRY7T.js").then((mod) => ({
  default: mod.NoPermissions
})));
var NoContentType = (0, import_react.lazy)(() => import("./NoContentTypePage-mxdu7QG9-PI4CFLSS.js").then((mod) => ({
  ...
  return (0, import_jsx_runtime.jsxs)(Menu.Root, {
    ...
    children: [
      (0, import_jsx_runtime.jsxs)(Menu.Trigger, {
        ...
        variant,
        children: [
          (0, import_jsx_runtime.jsx)(ForwardRef$1T, {
            "aria-hidden": true,
            focusable: false
          }),
...
var ConfigureTheViewAction = ({ collectionType, model }) => {
  ...
  return {
    ...
    icon: (0, import_jsx_runtime.jsx)(ForwardRef$2l, {}),
    onClick: () => {
...
var EditTheModelAction = ({ model }) => {
  ...
  return {
    ...
    icon: (0, import_jsx_runtime.jsx)(ForwardRef$1t, {}),
    onClick: () => {
...
var EntryValidationText = ({ validationErrors, status }) => {
  ...
  if (validationErrors) {
    ...
    return (0, import_jsx_runtime.jsxs)(Flex, {
      gap: 2,
      children: [
        (0, import_jsx_runtime.jsx)(ForwardRef$41, {
          fill: "danger600"
        }),
  ...
  if (status === "published") {
    return (0, import_jsx_runtime.jsxs)(Flex, {
      gap: 2,
      children: [
        (0, import_jsx_runtime.jsx)(ForwardRef$4B, {
          fill: "success600"
        }),
        (0, import_jsx_runtime.jsx)(Typography, {
  ...
  if (status === "modified") {
    return (0, import_jsx_runtime.jsxs)(Flex, {
      gap: 2,
      children: [
        (0, import_jsx_runtime.jsx)(ForwardRef$55, {
          fill: "alternative600"
        }),
        (0, import_jsx_runtime.jsx)(Typography, {
          children: formatMessage({
            ...
            children: [
              (0, import_jsx_runtime.jsx)(Td, {
                children: (0, import_jsx_runtime.jsx)(PublicationStatusSummary, {
                  ...
                  icon: (0, import_jsx_runtime.jsx)(ForwardRef$55, {
                    fill: "alternative600"
                  }),
                  message: formatMessage({
                    id: "content-manager.bulk-publish.modified",
              ...
              (0, import_jsx_runtime.jsx)(Td, {
                children: (0, import_jsx_runtime.jsx)(PublicationStatusSummary, {
                  ...
                  icon: (0, import_jsx_runtime.jsx)(ForwardRef$41, {
                    fill: "danger600"
                  }),
                  message: formatMessage({
          ...
          children: [
            (0, import_jsx_runtime.jsx)(Flex, {
              ...
              children: fieldPath.map((pathSegment, index2) => (0, import_jsx_runtime.jsxs)(Typography, {
                ...
                children: [
                  pathSegment,
                  index2 !== fieldPath.length - 1 && (0, import_jsx_runtime.jsx)(ForwardRef$4t, {
                    fill: "neutral500",
                    height: "0.8rem",
                    width: "0.8rem",
                    style: {
...
var StyledPencil = dt(ForwardRef$1t)`
  path {
    fill: currentColor;
  }
`;
...
var StyledDuplicate = dt(ForwardRef$3P)`
  path {
    fill: currentColor;
  }
`;
...
var HistoryAction = ({ model, document: document2 }) => {
  ...
  return {
    icon: (0, import_jsx_runtime.jsx)(ForwardRef$4n, {}),
    label: formatMessage({
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en-CImiNxXE-WX2TX2PC.js");
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-os6F94Aa-FGWMO55A.js");
        return {
          Component: Layout
        };
      },
...
prismjs/prism.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JHQ3QSDP.js.map
