...
var Root = ({ title, icon = ForwardRef$17, children }) => {
...
var HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import("./HomePage-MfOqcIag-LBMZRHM2.js")).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=chunk-2LPF3ZYR.js.map
