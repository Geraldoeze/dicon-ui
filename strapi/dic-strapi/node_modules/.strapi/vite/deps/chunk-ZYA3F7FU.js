...
// node_modules/@strapi/review-workflows/dist/admin/chunks/index-B0bafNic.mjs
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-DpKT2sjx-3RGMCQ23.js");
          return {
            default: Router
          };
        }
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-CEP8kvxZ-GLEQ36OZ.js");
          return {
...
//# sourceMappingURL=chunk-ZYA3F7FU.js.map
