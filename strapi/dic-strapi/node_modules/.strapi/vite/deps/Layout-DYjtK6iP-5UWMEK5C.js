...
var useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(ceLinks, async () => (await import("./index-BM8-DG5K-GS7RSVTJ.js").then(function(n) {
    return n.O;
  })).SETTINGS_LINKS_EE(), {
...
var CustomIcon = dt(ForwardRef$2r)`
  right: 15px;
  position: absolute;
  bottom: 50%;
...
//# sourceMappingURL=Layout-DYjtK6iP-5UWMEK5C.js.map
