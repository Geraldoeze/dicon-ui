...
var ReleaseActionModalForm = ({ documentId, document, model, collectionType }) => {
  ...
  return {
    ...
    icon: (0, import_jsx_runtime.jsx)(ForwardRef$1z, {}),
    ...
    children: [
      (0, import_jsx_runtime.jsx)(Popover.Trigger, {
        children: (0, import_jsx_runtime.jsx)(Button, {
          ...
          endIcon: releases.length > 0 ? (0, import_jsx_runtime.jsx)(ForwardRef$4R, {
            width: "1.2rem",
            height: "1.2rem"
          }) : null,
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-CuOosufQ-6AHRXTDO.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-BzdLEfxa-IEWPSDUJ.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-S1ccDSwp-TNCBLLIV.js");
          return {
...
//# sourceMappingURL=chunk-DYUWEA4N.js.map
