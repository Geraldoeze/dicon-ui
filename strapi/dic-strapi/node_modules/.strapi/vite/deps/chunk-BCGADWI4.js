...
var getEERoutes$1 = () => window.strapi.isEE ? [
  {
    ...
    lazy: async () => {
      const { AuthResponse } = await import("./AuthResponse-Cu7HgPEK-QZ2LV7WJ.js");
      return {
...
var BackButton = React10.forwardRef(({ disabled, fallback = "" }, ref) => {
  ...
  return (0, import_jsx_runtime.jsx)(Link2, {
    ...
    startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$5f, {}),
      ...
      (0, import_jsx_runtime.jsx)(Layouts.Content, {
        children: (0, import_jsx_runtime.jsx)(EmptyStateLayout, {
          action: (0, import_jsx_runtime.jsx)(LinkButton, {
            tag: Link,
            variant: "secondary",
            endIcon: (0, import_jsx_runtime.jsx)(ForwardRef$59, {}),
            to: "/",
            children: formatMessage({
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-BVI0O8bq-B3R727EW.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-CRzrEUGp-FTR5K4GO.js");
        return {
    ...
    children: [
      ...
      (0, import_jsx_runtime.jsx)(TextInput, {
        ...
        endAction: (0, import_jsx_runtime.jsx)(Field.Action, {
          ...
          children: showPassword ? (0, import_jsx_runtime.jsx)(ForwardRef$3B, {
            fill: "neutral500"
              ...
              (0, import_jsx_runtime.jsxs)(Flex, {
                ...
                children: [
                  ...
                  (0, import_jsx_runtime.jsx)(IconButton, {
                    ...
                    children: (0, import_jsx_runtime.jsx)(ForwardRef$43, {})
                  })
                ]
              }),
              (0, import_jsx_runtime.jsxs)(Flex, {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-Dtkhd0GV-ZKDEQGN7.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-BddeukI7-VFL4VQYI.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-srJutHdv-OKXJ54OO.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-DQDa78K3-PM7WL6VF.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-Bjr4f1Bs-63NTMWAX.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-B5Hb8BA--EFZ4VK74.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-MmQQ4hWc-OK5HD2SE.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-Cb-ETkOn-44DIQAHD.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-C44OaxjN-LU7YZX2L.js").then(function(n) {
        return n.b;
      });
      return {
        Component: ProtectedEditPage
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-BhGt3EBQ-DVTG7U7K.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView--KzJiQiO-3MQSKFCK.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-DZaIevIB-VKTA5H5H.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-CwdhHAuX-E7I4PIJY.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-CmubtWzn-IN4LDUL4.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-CoGoDDiF-LGEVMM53.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-CFIkvFrt-JZQMGY3M.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-5j7xjDqh-ULL35MV2.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-BI41XTBD-2MRR6JWJ.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-G1TKPP15-EEAUZGWU.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-BzC2C4Pv-R6BPJDU6.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-Bro5fyP3-C5SX24LA.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-DGTeFboL-UDIQPSUK.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-CN8SAQ9w-T3ZCPXGM.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-CcAYozK2-LLJLY3HE.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-DYjtK6iP-5UWMEK5C.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-DiEcqVEU-W7QGOTQS.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-C9eZ12Ue-G5BFN2HF.js");
              return {
...
//# sourceMappingURL=chunk-BCGADWI4.js.map
