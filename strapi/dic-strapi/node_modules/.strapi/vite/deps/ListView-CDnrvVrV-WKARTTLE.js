...
var StyledAddIcon = dt(ForwardRef$1f)`
  width: 3.2rem;
  height: 3.2rem;
  padding: 0.9rem;
  ...
  return (0, import_jsx_runtime.jsxs)(BoxWrapper$1, {
    children: [
      ...
      isMain && isInDevelopmentMode && (0, import_jsx_runtime.jsx)(TFooter, {
        cursor: "pointer",
        icon: (0, import_jsx_runtime.jsx)(ForwardRef$1f, {}),
        onClick: onClickAddField,
        children: formatMessage({
...
var ListView = () => {
  ...
  const secondaryAction = isInDevelopmentMode && !isFromPlugin && !isCreatingFirstContentType && (0, import_jsx_runtime.jsx)(Button, {
    startIcon: (0, import_jsx_runtime.jsx)(ForwardRef$1t, {}),
    variant: "tertiary",
    onClick: onEdit,
    children: formatMessage({
      id: "app.utils.edit",
...
//# sourceMappingURL=ListView-CDnrvVrV-WKARTTLE.js.map
