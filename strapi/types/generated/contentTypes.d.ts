...
export interface ApiAboutUsAboutUs extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    history_content: Schema.Attribute.JSON;
...
export interface ApiAllCommandantAllCommandant
  extends Struct.CollectionTypeSchema {
  collectionName: 'all_commandants';
  info: {
    displayName: 'AllCommandants';
    pluralName: 'all-commandants';
    singularName: 'all-commandant';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    commandants: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::all-commandant.all-commandant'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiCommandantCommandant extends Struct.CollectionTypeSchema {
  collectionName: 'commandants';
  info: {
    description: '';
    displayName: 'Commandant';
    pluralName: 'commandants';
    singularName: 'commandant';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiDepartmentAndCourseDepartmentAndCourse
  extends Struct.CollectionTypeSchema {
  collectionName: 'departments_and_courses';
  info: {
    displayName: 'Departments&Courses';
    pluralName: 'departments-and-courses';
    singularName: 'department-and-course';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::department-and-course.department-and-course'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiFooterFooter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    contact_info: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiInformationHeaderInformationHeader
  extends Struct.CollectionTypeSchema {
  collectionName: 'information_headers';
  info: {
    displayName: 'InformationHeader';
    pluralName: 'information-headers';
    singularName: 'information-header';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::information-header.information-header'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiPgProgramPgProgram extends Struct.CollectionTypeSchema {
  collectionName: 'pg_programs';
  info: {
    displayName: 'Pg Program';
    pluralName: 'pg-programs';
    singularName: 'pg-program';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    css_text: Schema.Attribute.Text;
    departments: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pg-program.pg-program'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tuition: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::all-commandant.all-commandant': ApiAllCommandantAllCommandant;
      'api::commandant.commandant': ApiCommandantCommandant;
      'api::department-and-course.department-and-course': ApiDepartmentAndCourseDepartmentAndCourse;
      ...
      'api::pg-program.pg-program': ApiPgProgramPgProgram;
