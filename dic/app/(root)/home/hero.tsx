  ...
  return (
    <div className="relative h-screen xl:max-h-[1200px] w-full overflow-hidden">
      ...
      {hero?.data.map((item) => (
              ...
              <div className="relative h-screen xl:max-h-[1200px] px-4 md:px-8 lg:px-16 xl:px-0 max-w-[85vw] mx-auto">
              {/* Center Content Section */}
               <div className="absolute top-1/2 -translate-y-1/2 max-w-2xl lg:max-w-3xl">
               {/* Title Section */}
