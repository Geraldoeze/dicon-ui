            ...
            <div className="min-w-screen min-h-screen flex">
                <div className="w-full min-h-full bg-[#080825] p-10">
                  ...
                  <div className="max-w-fit bg-[#080825] text-white p-2 rounded-md">
                    <Link href="/home" className="flex items-center gap-x-2 text-sm md:text-base">
                    <ArrowLeft />
                        Back
                    </Link>
                  </div>
                ...
                <div className="flex flex-col items-center justify-center max-w-md h-full m-auto space-y-7">
                    ...
                    <h1 className="text-[2rem] md:text-[2.5rem] text-white text-start font-semibold"> Log In to the Portal </h1>
                    ...
                    <form action="" className="space-y-7" onSubmit={handleSubmit} noValidate>
                        ...
                        <p className="text-white">forgot password? Click this
                        <a href="/portal/forgot-password" className="text-blue-500 text-underline"> link.</a>
                        </p>
                        <button type="submit" value="Log In"  disabled={isLoading} className="w-full bg-[#2D2F93] text-white p-2 rounded-md hover:bg-blue-600"> {isLoading ? 'Signing In...' : 'Sign In'} </button>
                    </form>
                </div>
                </div>
