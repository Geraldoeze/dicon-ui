...
import { Menu, User, GroupIcon, ArrowRight, GraduationCap, Search} from 'lucide-react';
...
function Overview() {
    ...
    const filteredApplications = applicationsData.filter((application: Application) => {
    ...
    <div className='max-w-[90vw] md:max-w-[80vw] mx-auto p-10 space-y-10'>
            ...
            <Card className="my-5">
              <CardHeader className='flex items-center justify-between flex-col md:flex-row'>
                <h1 className='text-[1.25rem] md:text-[1.5rem] font-medium'>Student Applications</h1>
                <div>
