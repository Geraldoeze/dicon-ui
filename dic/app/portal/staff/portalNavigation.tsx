...
const navItems = [
  { title: "Courses", icon: <BookOpen className="w-5 h-5" />, href: "/portal/staff/courses" },
  { title: "Classes", icon: <Users className="w-5 h-5" />, href: "/portal/staff/classes" },
  { title: "Assignments", icon: <ClipboardList className="w-5 h-5" />, href: "/portal/staff/assignments" },
  { title: "Exams", icon: <Pencil className="w-5 h-5" />, href: "/portal/staff/exams" },
];
        ...
        <div className="p-6 border-b border-gray-800">
          <Link href="/portal/student/profile" className="flex flex-col items-center space-y-3">
            ...
            <div className="text-center my-2">
              <h2 className="text-lg font-semibold">{user?.first_name || "Lecturer"}</h2>
